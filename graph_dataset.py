...
class AssemblyGraphDataset_HiFi(AssemblyGraphDataset):
    ...
    def process(self):
        ...
        for cnt, idx in enumerate(diff):
            ...
            subprocess.run(f'{self.hifiasm_path} --prt-raw -o {idx}_asm -t{self.threads} -l0 {reads_path}',
            ...
            graph, pred, succ, reads, edges, read_to_node, labels = graph_parser.only_from_gfa(gfa_path,
